...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ClickButton_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ClickButton_t qt_meta_stringdata_ClickButton = {
    {
QT_MOC_LITERAL(0, 11) // "ClickButton"
...
const QMetaObject ClickButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ClickButton.offsetsAndSize,
    qt_meta_data_ClickButton,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ClickButton_t
, QtPrivate::TypeAndForceComplete<ClickButton, std::true_type>
...
void *ClickButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClickButton.stringdata0))
